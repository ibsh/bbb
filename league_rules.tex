...
\par In order to create a team you have a treasury of \numprint{\TVGP} gold pieces. Study the team lists and decide which you want to use; all of the players in your team must be from the same team list.
...
\par Once a player has earned 6 SPPs they are entitled to their first Improvement roll. Each time that the player goes up another level, they must make another Improvement roll. The table below lists the number of SPPs that are required to reach each different level.

\medskip
\begin{tabularx}{\linewidth}{ | c | X | c | }
\hline
\textbf{SPPs} & \textbf{Title} & \textbf{Improvements} \\
\hline
0-5 & Rookie & 0 \\
\hline
6-15 & Experienced & 1 \\
...
\par Conceding a match also has an effect on SPPs. A player that concedes before setting up for a kick-off where they could not field enough players on the Line of Scrimmage suffers no additional penalties. If a coach concedes the match for any other reason, they receive no SPPs for this match. The winner receives SPPs as normal, plus one additional SPP per player on the team. Even players who missed the game due to a prior casualty receive this bonus SPP.
...
\begin{itemize}
\item Each improvement from a Normal category increases their value by 20 TV.
\item Each improvement from an Exceptional category increases their value by 30 TV.
